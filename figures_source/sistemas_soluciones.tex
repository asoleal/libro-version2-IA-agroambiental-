...
\begin{tikzpicture}[
    ...
    \begin{scope}[shift={(0,0)}]
        % CAMBIO: Subí la coordenada Y de 3.5 a 4.2
        \node[font=\bfseries\small] at (1.5, 4.2) {1. Solución Única};
        % CAMBIO: Subí la coordenada Y de 3.1 a 3.6
        \node[font=\footnotesize, gray] at (1.5, 3.6) {Cruce en un punto};
    ...
    \begin{scope}[shift={(5,0)}]
        % CAMBIO: Ajuste de altura
        \node[font=\bfseries\small] at (1.5, 4.2) {2. Sin Solución};
        \node[font=\footnotesize, gray] at (1.5, 3.6) {Paralelas distintas};
    ...
    \begin{scope}[shift={(10,0)}]
        % CAMBIO: Ajuste de altura
        \node[font=\bfseries\small] at (1.5, 4.2) {3. Infinitas Soluciones};
        \node[font=\footnotesize, gray] at (1.5, 3.6) {Coincidentes};
